...
{
    Task<PersonResponse?> GetAsync(Expression<Func<Person, bool>> predicate,
        string? includeProperties,
        CancellationToken cancellationToken = default);

    Task<List<PersonResponse>> GetAllAsync(Expression<Func<Person, bool>>? predicate = null,
    ...
    Task<int> CountAsync(Expression<Func<Person, bool>>? predicate = null,
        CancellationToken cancellationToken = default);
}