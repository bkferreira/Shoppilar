...
public class JobService(IRepo<Job> repository) : IJobService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var result = new JobResponse(entity);
        return result;
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var results = entities.Select(x => new JobResponse(x)).ToList();
        return results;
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var results = new PaginatedResponse<JobResponse>(items, totalCount);
        return results;
    }

    public async Task<JobResponse?> InsertAsync(JobInput input,
        CancellationToken cancellationToken = default)
    {
        var entity = new Job
        {
    ...
    public async Task<JobResponse?> UpdateAsync(JobInput input,
        CancellationToken cancellationToken = default)
    {
